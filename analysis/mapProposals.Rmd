...
sc <- SparkR::sparkR.init(master="local[2]")
...
```{r}
    ...
    ggplot(joined.pres,aes(x=`EFSA infections`, y=`Magarey\nasco_days\naverage`)) + 
      geom_point() +
      geom_smooth() +
      ggtitle("Magarey et al. 2015 and EFSA2014 ascospore infection scores for the 36 Magarey et al. 2015 EU locations") +
      labs(x="EFSA2014 infection score",y="Magarey et al. 2015 infection score")
```
#### linear model
```{r}
...
```{r}
      ...
      geom_smooth() +
            ggtitle("Magarey et al. 2015 and EFSA2014 ranked ascospore infection scores for the 36 Magarey el al. EU locations") +
      labs(x="Ranked EFSA2014 infection score",y="Ranked Magarey et al. 2015 infection score")
...
```{r}
        ggplot(joined.pres,aes(x=rank(`EFSA infections`), y=rank(`Magarey\nasco_days\naverage`))) +       geom_point() +
      geom_smooth(method = "lm") +
            ggtitle("Magarey et al. 2015 and EFSA2014 ranked ascospore infection scores for the 36 Magarey et al. 2015 EU locations") +
      labs(x="Ranked EFSA2014 infection score",y="Ranked Magarey et al. 2015 infection score")
